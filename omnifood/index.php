...
<body>
	<header id="home">
		<nav>
			<div class="row">
				<a href="#home"><img src="./resources/img/logo-white.png" alt="Omnifood logo" class="logo"></a>
		...
		<div class="row">
			...
			<div class="row">
				<div class="col span-1-of-2 steps-box">
					<img src="./resources/img/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen row js--wp-2">
				</div>
				<div class="col span-1-of-2 steps-box">
			...
			<div class="row js--wp-3">
				<div class="col span-1-of-4 box">
					...
					<div class="city-feature">
						<i class="icon ion-ios-person icon-small"></i> 1600+ happy eaters
					</div>
					<div class="city-feature">
						<i class="icon ion-ios-star icon-small"></i> 60+ top chefs
					</div>
					<div class="city-feature">
				...
				<div class="col span-1-of-4 box">
					...
					<h3>San Francisco</h3>
					<div class="city-feature">
						<i class="icon ion-ios-person icon-small"></i> 3700+ happy eaters
					</div>
					<div class="city-feature">
						<i class="icon ion-ios-star icon-small"></i> 160+ top chefs
					</div>
					<div class="city-feature">
						<i class="icon ion-logo-twitter icon-small"></i>
				...
				<div class="col span-1-of-4 box">
					...
					<h3>Berlin</h3>
					<div class="city-feature">
						<i class="icon ion-ios-person icon-small"></i> 2300+ happy eaters
					</div>
					<div class="city-feature">
						<i class="icon ion-ios-star icon-small"></i> 110+ top chefs
					</div>
					<div class="city-feature">
						<i class="icon ion-logo-twitter icon-small"></i>
				...
				<div class="col span-1-of-4 box">
					...
					<h3>London</h3>
					<div class="city-feature">
						<i class="icon ion-ios-person icon-small"></i> 1200+ happy eaters
					</div>
					<div class="city-feature">
						<i class="icon ion-ios-star icon-small"></i> 50+ top chefs
					</div>
					<div class="city-feature">
						<i class="icon ion-logo-twitter icon-small"></i>
